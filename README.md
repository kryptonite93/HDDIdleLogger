...
- Consecutive active polls still define sample-resolution gaps, so sub-minute “idle” statistics do not imply sustained physical inactivity. Custom timers shorter than the sample interval have particularly weak resolution.
